...
- **Finder** — cross-host list with per-thread summaries (latest brief chunk summary), projected LHC view estimates, sortable columns, host/directory/text filters, health dots, live refresh. Hosts: cc-lhc, pi-lhc, codex-lhc, t3code-lhc, and hermes (registry-less: scans `~/.hermes{,/profiles/<name>}/lhc/threads`)
